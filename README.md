> **Before working on this repository, read these 8 documents in order:**
...
**Production backend:** `https://alphacycle-production.up.railway.app` (see `index.html` `BACKEND_URL`). Deploy log: `DEPLOY_STATE.md`. Canonical docs: the eight files listed above under `docs/` (see `docs/SYSTEM_VERSION.md` for version SSOT).
