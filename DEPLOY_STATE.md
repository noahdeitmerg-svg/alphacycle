...
## Letzter Session-Status (2026-03-04) — BTC Chart High-Low Range
- **BTC Chart High-Low Range**: Backtest liefert pro Woche high/low (Kraken OHLC c[2]/c[3]); backtest_engine Cache und results mit "high", "low", "price" (close). ARC-Berechnung unverändert auf Close. index.html: BTC-Preis als High-Low-Band (Dataset BTC High-Low fill zu BTC Low, rgba(234,179,8,0.15)), BTC Close-Linie dünn gelb, BTC Low transparent. Cycle-Marker TOP/BOTTOM zeigen result.high bzw. result.low. ATH-Bereich ~$126k sichtbar.
...
80. **BTC Chart High-Low Range**: backtest_engine returns per week high/low (Kraken OHLC c[2], c[3]); cache and results include "high", "low", "price" (close). ARC calculation unchanged (close only). index.html ARC History Chart: BTC as High-Low band (fill rgba(234,179,8,0.15)), BTC Close line thin yellow, BTC Low transparent; cycle markers TOP/BOTTOM use result.high and result.low. ATH band ~$126k visible.
