...
56. index.html: Mobile Responsive Dashboard. @media (max-width: 768px): dashboard/cards/scores/metrics auf 1 Spalte, kleinere Hero-Padding, ARC-Chart-Höhe 250px, kleinere Data Inspector Schrift, Ticker-Bar hidden, kein horizontaler Scroll, kompakter Nav/Score-Cards. ARC Chart (Chart.js) mit maintainAspectRatio: false. Boot-Screen Text „CONNECTING TO KRAKEN…“ (statt COINGECKO).
