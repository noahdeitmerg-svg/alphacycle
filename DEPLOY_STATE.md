...
## Letzter Session-Status (2026-03-04) — ARC High/Low Engine
...
- **Fix #86 — Cycle Phase Colors**: _setCyclePhaseTag() colMap in index.html ist vollständig — alle 12 Phasen (Early/Mid/Late/Deep Bear, Accumulation/Deep Accumulation, Early/Mid/Late Bull, Distribution, Bear / Risk Off, Transition) haben definierte Farben im Cycle Overview Tag.
